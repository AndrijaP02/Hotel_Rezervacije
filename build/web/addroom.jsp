...
<html>
    ...
    <body>
        ...
        <form action="addroom" enctype="multipart/form-data" method="post">
            <p>Enter Hotel Id To Add Room:</p>
            <input type="text" name="hotelId" required placeholder="Enter Hotel Id">
            <p>Enter Room Adults Number:</p>
            <input type="text" name="adultsNum" required placeholder="Room Adults Number">
            <p>Enter Room Children Number:</p>
            <input type="text" name="childrenNum" required placeholder="Room Children Number">
            <p>Enter Room Price:</p>
            <input type="text" name="price" required placeholder="Enter Room Price"><br><br>
