...
<html>
    ...
    <body>
        ...
        <form action="updateHotelInformation">
            ...
            <input type="text" name="hotelid" required placeholder="Enter Hotel Id"><br><br>
            <label>Enter Hotel Name: </label><br>

            <input type="text" name="hotelname" required placeholder="Enter Hotel Name"><br><br>
            <label>Enter Hotel Location: </label><br>
            <input type="text" name="hotellocation" required placeholder="Enter Hotel Location"><br><br>

            <label>Enter Hotel Email: </label><br>
            <input type="text" name="hotelemail" required placeholder="Enter Hotel Email"><br><br>
            <label>Enter Hotel Phone: </label><br>
            <input type="text" name="hotelphone" required placeholder="Enter Hotel Phone"><br><br>
